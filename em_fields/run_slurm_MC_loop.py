...
for RF_type, RF_amplitude in zip(RF_type_list, RF_amplitude_list):
    for induced_fields_factor in induced_fields_factor_list:
        if RF_type == 'electric_transverse' and induced_fields_factor == 0:
            pass  # skipping this option
        else:
            for gas_name in gas_name_list:
                for sigma_r0 in sigma_r0_list:
                    for with_kr_correction in with_kr_correction_list:
                        ...
                        print('@@@@@ sigma_r0:', sigma_r0)
                        print('@@@@@ induced_fields_factor:', induced_fields_factor)
                        print('@@@@@ with_kr_correction:', with_kr_correction)
                        ...
                        for combination in combinations_list:
                            ...
                            if RF_type == 'electric_transverse':
                                field_dict['E_RF_kVm'] = RF_amplitude
                            elif RF_type == 'magnetic_transverse':
                                field_dict['B_RF'] = RF_amplitude
                            ...
                            field_dict['with_kr_correction'] = with_kr_correction
                            ...
                            # time that depends on D,T v_th
                            settings['t_max'] = 1 * settings['l'] / settings['v_th']
                            # settings['t_max'] = 5 * settings['l'] / settings['v_th']
                            # settings['t_max'] = 10 * settings['l'] / settings['v_th']
