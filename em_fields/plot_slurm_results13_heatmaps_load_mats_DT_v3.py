...
for alpha, beta, set_name in zip(select_alpha_list, select_beta_list, set_name_list):
    ...
    print('RF_capacity_rl_list += [' + '{:.3f}'.format(N_rl_1[ind_beta, ind_alpha]) + ']')
    print('RF_capacity_lr_list += [' + '{:.3f}'.format(N_lr_1[ind_beta, ind_alpha]) + ']')
    print('T:')
    ...
    print('RF_capacity_rl_list += [' + '{:.3f}'.format(N_rl_2[ind_beta, ind_alpha]) + ']')
    print('RF_capacity_lr_list += [' + '{:.3f}'.format(N_lr_2[ind_beta, ind_alpha]) + ']')
